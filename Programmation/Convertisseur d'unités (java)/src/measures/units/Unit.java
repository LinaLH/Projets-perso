...
//		System.out.println(this + " Setting value = " + this.value.get());
	 ...
	 */
	public void convertValueTo(Unit<?> unit)
	{
		this.convertValueFrom(unit);
	    ...
	    throws NullPointerException
	{
		...
		{
			case NAME_ASCENDING:
				// DONE Complete using nameCompare or factorCompare if nameCompare is inconclusive
				result = (nameCompare == 0 ? factorCompare : nameCompare);
				break;
			...
			case FACTOR_ASCENDING:
				// DONE Complete using factorComparee or nameCompare if factorCompare is inconclusive
				result = (factorCompare == 0 ? nameCompare : factorCompare);
				break;
